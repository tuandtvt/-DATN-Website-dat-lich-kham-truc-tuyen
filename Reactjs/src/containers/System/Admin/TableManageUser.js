              ...
              <Table>
                ...
                <TableBody>
                  {arrUsers.map((row) => {
                    ...
                    let imageBase64 = image ? new Buffer(image, "base64").toString("binary") : "";
                    ...
                    return (
                      <TableRow hover key={id} tabIndex={-1}>
                        ...
                        <TableCell align="right">
                          <Button variant="contained" color="primary" onClick={() => this.handleEditUser(row)}>
                            {language === "vi" ? "Chỉnh sửa" : "Edit"}
                          </Button>
                          <Button variant="contained" color="error" onClick={() => this.handleDeleteUser(row)}>
