    ...
    return (
      <div>
        ...
        <div class="row mb-60 p-15" >
            <div class="col-12">
                <h3 class="mt-8"><FormattedMessage id="medical-history.filters" /></h3>
            </div>
            <div class="col-3">
                <div class="form-group">
                        <label for="name"><FormattedMessage id="admin.manage-doctor.name" /></label>
                        <input  type="text" value={name} class="form-control" id="name"placeholder="" 
                          onChange={(event) =>
            ...
            <div class="col-12"><button type="submit" class="btn btn-primary pointer" onClick={()=>handleFilter()}><FormattedMessage id="medical-history.apply" /></button></div>
        </div>

        <div class="row">
            <div class="col-12 text-right mb-16">
                <button type="submit" class="btn btn-primary pointer mr-5"
                onClick={()=>{navigate(`/admin-dashboard/manage-drug/create`, { replace: true });}}
                  ...
                  return(
                    <tr>
                        ...
                        <td class="text-right">
                              <button
                                className="btn-edit"
                                onClick={()=>{navigate(`/admin-dashboard/manage-drug/edit/${drug.id}`, { replace: true });}}
                              >
