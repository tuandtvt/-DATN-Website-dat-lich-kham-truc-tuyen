...
export default function CreateRemedy() {
  ...
  const handleResetDrugs=async ()=>{
    ...
    >
        ...
        <div className="row">
          <div class="col-12"><h5 className=""><FormattedMessage id={"admin.manage-drug.create-prescription"} /></h5></div>
        </div>
          <div className="row">
            <div class="col-8">
              <div class="row">
          ...
          <button  onClick={() => handleCreateRemedyImage()} type="button" class="btn btn-primary"><FormattedMessage id={"admin.manage-drug.btn-create"} /></button>
