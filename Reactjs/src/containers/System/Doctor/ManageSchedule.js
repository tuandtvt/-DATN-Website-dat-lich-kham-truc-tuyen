...
//     }
//     // if (selectedDoctor && _.isEmpty(selectedDoctor)) {
//     //   toast.error(this.props.language === LANGUAGES.EN ? "Invalid selected doctor!" : "Bác sĩ chọn không hợp lệ!");
//     //   return;
//     // }
//     // if (selectedPackage && _.isEmpty(selectedPackage)) {
//     //   toast.error(this.props.language === LANGUAGES.EN ? "Invalid selected package!" : "Gói khám chọn không hợp lệ!");
//     //   return;
//     // }
...
//         selectedTime.map((schedule) => {
//           let object = {};
//           selectedDoctor!==null? object.doctorId = selectedDoctor.value:object.packagesId=selectedPackage.value;
//           object.date = formatedDate;
//           object.timeType = schedule.keyMap;
//           //object.packagesId = selectedPackage.value; // Thêm dòng này để lưu gói khám
//           result.push(object);
//         });
//       } else {
...
//     let res = selectedDoctor!==null? await saveBulkScheduleDoctor({
//       arrSchedule: result,
//       doctorId: selectedDoctor.value,
//       date: formatedDate,
...
//     });;
//     if (res && res.errCode === 0) {
//       toast.success(this.props.language === LANGUAGES.EN ? "Save infor succeed!" : "Lưu thông tin thành công!");
//     } else {
