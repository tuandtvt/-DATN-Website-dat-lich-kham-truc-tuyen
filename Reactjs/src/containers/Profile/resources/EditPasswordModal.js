                ...
                <div className="row">
                    ...
                    <div className="col-12 form-group">
                        ...
                        <div class="custom-input-password">
                            ...
                            />
                             <i class={!eyeCurrentPassword ? "fas fa-eye-slash" : "far fa-eye"}
                    ...
                    <div className="col-12 form-group">
                        ...
                        />
                          <i class={!eyeNewPassword ? "fas fa-eye-slash" : "far fa-eye"}
                    ...
                    <div className="col-12 form-group">
                        ...
                        />
                         <i class={!eyeConfirmPassword ? "fas fa-eye-slash" : "far fa-eye"}
