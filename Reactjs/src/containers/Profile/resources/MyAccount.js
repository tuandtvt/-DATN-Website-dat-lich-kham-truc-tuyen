                ...
                <div class="rsolution-card-body">
                    <div class="row">
                        <div class="col-auto pt-20">
                            <div class="avatar-box" style={{width:"185px",height:"185px",backgroundImage: `url(${previewImgURL})`}}
                            ></div>
                            <div class="text-center fs-25 font-weight-bold text-secondary text-truncate mt-10">{firstName} {lastName}</div>
                        </div>
                        <div class="col">
                            <div class="row my-20">
                                <div class="col-auto" style={{width:"130px"}}>
                                    <h6 class="font-weight-bold mb-0"><FormattedMessage id="profile-setting.name" />:</h6>
                                </div>
                                <div class="col">
                                    <h6 class="mb-0 truncate">{firstName} {lastName}</h6>
                                </div>
                            </div>

                            <div class="row my-20">
                                <div class="col-auto" style={{width:"130px"}}>
                                    <h6 class="font-weight-bold mb-0"><FormattedMessage id="profile-setting.gender" />:</h6>
                                </div>
                                <div class="col">
                            ...
                            <div class="row my-20">
                                <div class="col-auto" style={{width:"130px"}}>
                                    <h6 class="font-weight-bold mb-0"><FormattedMessage id="profile-setting.phone" />:</h6>
                                </div>
                                <div class="col">
                            ...
                            <div class="row my-20">
                                <div class="col-auto" style={{width:"130px"}}>
                                    <h6 class="font-weight-bold mb-0"><FormattedMessage id="profile-setting.address" />:</h6>
                                </div>
                                <div class="col">
                            ...
                            <div class="row my-20">
                                <div class="col-auto" style={{width:"130px"}}>
                                    <h6 class="font-weight-bold mb-0"><FormattedMessage id="profile-setting.password" />:</h6>
                                </div>
                                <div class="col">
                                    <h6 class="mb-0 truncate">*********</h6>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-pencil-alt pointer" onClick={()=>setIsOpenModalEditPassword(true)}></i>
                                </div>
                            </div>

                            <button class="btn btn-outline-primary btn-block" onClick={()=>setIsOpenModalBooking(true)}><i class="fas fa-edit mr-8"></i><FormattedMessage id="profile-setting.btn-edit-profile" /></button>
                        </div>
                    </div>
                </div>
            </div>
