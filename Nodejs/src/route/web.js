...
let initWebRoutes = (app) => {
  ...
  router.post("/api/create-new-package", packageController.createPackage);
  router.get("/api/get-all-package", packageController.getAllPackage);
  router.post("/api/filter-package", packageController.filterPackage);
  router.post("/api/edit-package", packageController.udatePackageData);
  router.get(
  ...
  router.get(
    "/api/get-list-patient-for-package",
    packageController.getListPatientForPackage
  );

  router.get(
    "/api/get-bookingpackage-by-id",
    packageController.getBookingPackageById
  );

  router.post("/api/cancel-bookingpackage", packageController.cancelBookingPackage);
  router.post("/api/confirm-bookingpackage", packageController.confirmBookingPackage);
  ...
  router.get(
    "/api/get-schedule-package-by-date",
    packageController.getScheduleByDate
  );

  router.post("/api/bulk-createpackage-schedule", packageController.bulkCreateSchedule);

  router.post("/api/confirm-package", packageController.confirmPackage);

  router.post("/api/api/cancel-package", packageController.cancelPackage);

  router.get(
    "/api/get-extra-infor-package-by-id",
    packageController.getExtraInforPackageById
  );
  router.post(
    "/api/post-package-bookappointment",
    packageController.postBookAppointment
  );
  ...
  router.get(
    "/api/get-total-health-appointment-done1",
    adminController.getTotalHealthAppointmentDone1
  );
